...
class CreateCustomsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('customs', function (Blueprint $table) {
            ...
            $table->tinyInteger('payment_type')->nullable()->default(1)->comment('支付方式: 1: 押一付一 2: 押一付二 3: 押一付三 4: 押二付一 5: 押二付二 6: 押二付三 7: 押三付一 8: 押三付二 9: 押三付三 10: 半年付 11: 年付 12: 面谈');
            $table->decimal('pay_commission', 10, 2)->nullable()->comment('付佣');
            $table->tinyInteger('pay_commission_unit')->nullable()->default(1)->comment('付佣单位: 1: % 2: 多少元');

            $table->tinyInteger('need_type')->comment('求租类型：1-住宅 2-写字楼 3-商铺')->nullable();
            $table->tinyInteger('renting_style')->nullable()->default(1)->comment('住宅： 出租方式: 1: 整租 2: 合租');
            $table->tinyInteger('office_building_type')->nullable()->default(1)->comment('写字楼： 写字楼类型 1: 纯写字楼 2: 商住楼 3: 商业综合体楼 4: 酒店写字楼 5: 其他');
            $table->tinyInteger('shops_type')->nullable()->default(1)->comment('商铺类型 1: 住宅底商 2: 商业街商铺 3: 酒店商底 4: 社区商铺 5: 沿街商铺 6: 写字底商 7: 购物中心 8: 旅游商铺 9: 其他');
            ...
            $table->tinyInteger('orientation')->nullable()->default(1)->comment('朝向: 1: 东 2: 南 3: 西 4: 北 5: 东南 6: 西南 7: 东北 8: 西北');
