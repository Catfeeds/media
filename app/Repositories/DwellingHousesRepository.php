...
class DwellingHousesRepository extends BaseRepository
{
    ...
    public function addDwellingHouses($request, HousesService $housesService)
    {
        ...
        try {
            $house = $this->model->create([
                ...
                'feature_lable' => $request->feature_lable??array(),
    ...
    public function updateDwellingHouses($dwellingHouse, $request)
    {
        ...
        $dwellingHouse->feature_lable = $request->feature_lable??array();
        $dwellingHouse->support_facilities = $request->support_facilities??array();
        ...
        $dwellingHouse->cost_detail = $request->cost_detail??array();
