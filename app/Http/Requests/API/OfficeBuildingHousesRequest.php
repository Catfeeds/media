        ...
        switch ($this->method()) {
            case 'POST':
                return [
                    ...
                    'office_furniture.max' => '办公家具最大长度为32位',
                    'register_company.between' => '公司注册异常',
                    'station_number.numeric' => '工位数量必须为数字',
                    'station_number.max' => '工位数量最大长度为10位',
        ...
        switch ($this->method()) {
            case 'POST':
                return [
                    ...
                    'orientation' => 'max:32',
                    'office_furniture' => 'max:32',
                    'register_company' => 'nullable|between:1,2',
                    'station_number' => 'nullable|numeric|max:99999999999',
